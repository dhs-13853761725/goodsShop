                    ...
                    <div class="am-tab-panel">
                        <form method="post" id="reg-form">
                            ...
                            <div class="user-pass">
                                ...
                                <input type="password"  id="userPassCheck"onblur="userPassCheckFun()" placeholder="确认密码">
                        ...
                        <div class="am-cf">
                            <input type="submit" name="" onclick="saveU()" value="注册" class="am-btn am-btn-primary am-btn-sm am-fl">
                        </div>
                        <hr>
                    </div>
                    <script>
