...
<div class="am-container header">
  ...
  <ul class="message-r">
    ...
    <div class="topMessage mini-cart"><div class="menu-hd"><a id="mc-menu-hd" href="shopcartMain?userId=${userId}" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div></div>
 ...
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       ...
       <div class="user-info">
         <p>收货人：${o.addressName!}</p>
         <p>联系电话：${o.addressPhone!}</p>
         <p>收货地址：${o.addressProvince!} ${o.addressCity!} ${o.addressCounty!} ${o.addressDetailed!}</p>
       </div>
