...
<head>
    <meta http-equiv="Content-Type" content="text/html; charseum-t=utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimscale=1.0, maximum-scale=1.0, user-scalable=no">
...
<div class="nav white">
    ...
    <div class="search-bar pr">
        ...
        <form>
            <input id="searchInput" name="comName" type="text" placeholder="搜索" autocomplete="off">
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${commodity.comMoney!}</b>  </dd>
                    </li>
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em><b class="sys_item_mktprice">${commodity.comPrice!}</b></dd>
                    </li>
                    <div class="clear"></div>
                </div>
                ...
                <dl class="iteminfo_parameter freight">
                    ...
                    <div class="iteminfo_freprice">
                        ...
                        <div class="pay-logis">
                            快递<b class="sys_item_freprice">${commodity.comFreight!}</b>元
                        </div>
                    </div>
                </dl>
                <div class="clear"></div>
                ...
                <ul class="tm-ind-panel">
                    <li class="tm-ind-item tm-ind-sellCount canClick">
                        <div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">${commodity.comMonthsales!}</span></div>
                    </li>
                    <li class="tm-ind-item tm-ind-sumCount canClick">
                        <div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">${commodity.comTotalsales!}</span></div>
                    </li>
                    <li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
                        <div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count">${commodity.comTotalevaluate!}</span></div>
                    </li>
                </ul>
                <div class="clear"></div>
...
<div class="pay">
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login">
            <a id="eee" title="加入我的收藏" href="#">加入我的收藏</a>
        </div>
    </li>
</div>
    ...
    <div class="introduceMain">
        <div class="am-tabs" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                ...
                <div class="am-tab-panel am-fa'de am-in am-active">
                    <div class="J_Brand">
